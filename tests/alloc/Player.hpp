...
class Player
{
    ...
    Player(Player const &tocopy); //constructeur de copie pour prévoir cas ou un pointeur est déclaré dans unc lasse et qu'on veut allouer de nouveau de la mémoire pour une nouvelle copie.
    ~Player(); //destructeur
